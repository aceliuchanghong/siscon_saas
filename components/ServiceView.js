function ServiceView({ currentService, isLoggedIn }) {
  try {
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="bg-white rounded-xl p-6 border border-[var(--border-color)]">
                  ...
                  <h3 className="text-lg font-semibold mb-2">客户管理</h3>
                  <p className="text-[var(--text-secondary)]">管理客户关系，提升销售效率</p>
                </div>
                <div className="bg-white rounded-xl p-6 border border-[var(--border-color)]">
                  <div className="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center mb-4">
                    <div className="icon-chart-bar text-xl text-green-600"></div>
                  </div>
                  <h3 className="text-lg font-semibold mb-2">数据分析</h3>
                  <p className="text-[var(--text-secondary)]">实时数据洞察，智能决策支持</p>
                </div>
                <div className="bg-white rounded-xl p-6 border border-[var(--border-color)]">
                  <div className="w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center mb-4">
                    <div className="icon-cloud text-xl text-purple-600"></div>
                  </div>
                  <h3 className="text-lg font-semibold mb-2">云存储</h3>
                  <p className="text-[var(--text-secondary)]">安全可靠的文件存储与共享</p>
                </div>
              </div>
            </div>
          );
